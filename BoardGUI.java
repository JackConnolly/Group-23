...
* @author Jack Connolly, Anna Barrett, Kylie Sicat, Hailey Allen
* last updated by: Kylie
* @since 04-07-19
*/
...
public class BoardGUI extends Application {
    ...
    /** Function to check player position and display image onto button (with 2 human players)
    * @param player1 Human Player
	* @param player2 Computer Player
	* @return boxes of where the player is in
	*/
	...
	/**Function to check player position and display image onto button (with AI player)
	* @param player1 Human Player
	* @param player2 Computer Player
	* @return boxes of where the player is in
	*/
	...
	*/
	...
	public void start(Stage primaryStage) throws Exception {
		...
		this.player1 = new HumanPlayer("", 1, 0, "player1.png");
		this.player2 = new HumanPlayer("", 3, 4, "player2.png");
		// initializing AIPlayer so if you have no friends you can play with the computer
		this.player3 = new AIPlayer("", 3, 4, "player2.png", cards, player1);
		this.turn = 1;
		this.rooms = rooms;

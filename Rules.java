public class Rules {
	...
	public void printRules() {
		...
		// Equipment
		System.out.println("Equipment:\nSix colored tokens representing the suspects in the house.\nThe colors of the pieces are closely associated with the names of the suspects: \nMiss Scarlet     (red) \nProfessor Plum      (purple) \nMr. Green     (green) \nMrs. White    (white)");
		System.out.println("4 miniature weapons and one die.");
		System.out.println("The pack of 21 illustrated cards includes a card for each of the 6 suspects, one for each of the 6 weapons, and one for each of the 9 rooms. There is also a pad of Detective Notes to aid the players in their investigations.");
		System.out.println("The game Board showing nine rooms of Mr. Boddy's house.");
